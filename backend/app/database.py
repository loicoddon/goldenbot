...
async def init_db() -> None:
    ...
    async with engine.begin() as conn:
        ...
        migrations = [
            ...
            "ALTER TABLE bot_settings ADD COLUMN IF NOT EXISTS confidence_skip_low FLOAT DEFAULT 0",
            "ALTER TABLE bot_settings ADD COLUMN IF NOT EXISTS confidence_skip_high FLOAT DEFAULT 0",
        ]
